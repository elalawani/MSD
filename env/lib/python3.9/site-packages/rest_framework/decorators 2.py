...
def api_view(http_method_names=None):
    """
    Decorator that converts a function-based views into an APIView subclass.
    Takes a list of allowed methods for the views as an argument.
    """
...
def action(methods=None, detail=None, url_path=None, url_name=None, **kwargs):
    ...
    :param kwargs: Additional properties to set on the views.  This can be used
