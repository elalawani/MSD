...
some fairly ad-hoc information about the views.
...
class BaseMetadata:
    def determine_metadata(self, request, view):
        """
        Return a dictionary of metadata about the views.
...
class SimpleMetadata(BaseMetadata):
    ...
    It returns an ad-hoc set of information about the views.
    ...
    def determine_actions(self, request, view):
        ...
        for method in {'PUT', 'POST'} & set(view.allowed_methods):
            ...
            try:
                ...
                # If user has appropriate permissions for the views, include
