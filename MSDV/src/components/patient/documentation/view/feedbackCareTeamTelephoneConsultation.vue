            ...
            >
                <div class="w-full bg-sky-700">
                    <h1 class="flex justify-around text-[min(10vw,30px)] p-4">
                        Rückmeldung an das Versorgungsteam nach telefonischer
                        Konsultation
                    </h1>
                </div>
                <div v-if="feedbackCareTeamTelephoneConsultations.length">
                    <div class="flex flex-row justify-between container px-4">
                        ...
                        >
                            <option
                                v-for="(
                                    _, index
                                ) in feedbackCareTeamTelephoneConsultations"
                                :value="index"
                                :key="index"
                            >
                    ...
                    <div
                        v-for="(
                            feedbackCareTeamTelephoneConsultation, index
                        ) in feedbackCareTeamTelephoneConsultations"
                        ...
                        >
                            <tbody>
                                ...
                                >
                                    ...
                                    <td class="pl-2 py-4">
                                        {{
                                            feedbackCareTeamTelephoneConsultation.note
                                        }}
                                    </td>
                                </tr>
                            </tbody>
...
const feedbackCareTeamTelephoneConsultations = computed(
    () =>
        feedbackCareTeamTelephoneConsultation.feedback_careTeam_telephone_consultation
);
let selected = ref(feedbackCareTeamTelephoneConsultations.value.length - 1);
watch(
    feedbackCareTeamTelephoneConsultations,
    async (newFeedbackCareTeamTelephoneConsultations) => {
        selected.value = newFeedbackCareTeamTelephoneConsultations.length - 1;
    },
    { immediate: true }
);
</script>
