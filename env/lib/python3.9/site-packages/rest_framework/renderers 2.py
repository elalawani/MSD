...
class TemplateHTMLRenderer(BaseRenderer):
    ...
    3. The return result of calling `views.get_template_names()`.
    ...
    def get_template_names(self, response, view):
        ...
        raise ImproperlyConfigured(
            'Returned a template response with no `template_name` attribute set on either the views or response'
        )
...
class BrowsableAPIRenderer(BaseRenderer):
    ...
    def get_filter_form(self, data, view, request):
        ...
        # Infer if this is a list views or not.
...
class AdminRenderer(BrowsableAPIRenderer):
    ...
    def render(self, data, accepted_media_type=None, renderer_context=None):
        ...
        response = renderer_context['response']
        request = renderer_context['request']
        view = self.renderer_context['views']
    ...
    def get_context(self, data, accepted_media_type, renderer_context):
        ...
        paginator = getattr(context['views'], 'paginator', None)
        ...
        if isinstance(results, list) and 'views' in renderer_context:
            for result in results:
                url = self.get_result_url(result, context['views'])
                if url is not None:
    ...
    def get_result_url(self, result, view):
        """
        Attempt to reverse the result's detail views URL.
