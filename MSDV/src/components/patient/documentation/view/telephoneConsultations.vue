    ...
    <suspense>
        <template #default>
            ...
            >
                ...
                <div v-if="telephoneConsultations.length">
                    <div class="flex flex-row justify-between container px-4">
                        ...
                        >
                            <option
                                v-for="(_, index) in telephoneConsultations"
                                :value="index"
                                :key="index"
                            >
                    ...
                    <div
                        v-for="(
                            telephoneConsultation, index
                        ) in telephoneConsultations"
                        ...
                        >
                            <tbody>
                                ...
                                >
                                    ...
                                    <td class="pl-2 py-4">
                                        {{
                                            telephoneConsultation.created_by
                                                .username
                                        }}
                                    </td>
                                </tr>
...
const telephoneConsultations = computed(
    () => telephoneConsultation.telephone_consultations
);
const selected = ref(telephoneConsultations.value.length - 1);
watch(
    telephoneConsultations,
    async (newTelephoneConsultations) => {
        selected.value = newTelephoneConsultations.length - 1;
    },
    { immediate: true }
);
</script>
